...
- Estrutura simples e componentizada o suficiente para a proposta
- Layout responsivo para desktop e mobile
- HTML semantico
- CSS organizado por blocos de interface
- Ajuste de dependencias para compatibilidade mais estavel com o ambiente atual